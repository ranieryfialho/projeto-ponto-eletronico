                ...
                {usuario?.role === 'admin' && (
                    <div className="relative">
                        <button
                            ...
                            className="text-white bg-indigo-950 px-3 py-1 rounded hover:bg-indigo-950"
                        >
                            ☰
                        </button>
                        {menuAberto && (
                            <div className="absolute right-0 mt-2 w-48 bg-white shadow rounded text-black z-10">
                                <Link
                                    to="/"
